...
HD_PWD='C:/Users/Matt/thesis/vivado/thesis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hardware_top.tcl -notrace
