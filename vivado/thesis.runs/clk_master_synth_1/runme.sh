...
HD_PWD='C:/Users/Matt/thesis/vivado/thesis.runs/clk_master_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_master.tcl
