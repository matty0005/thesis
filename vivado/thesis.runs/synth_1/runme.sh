...
HD_PWD='C:/Users/Matt/thesis/vivado/thesis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware_top.tcl
