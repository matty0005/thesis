...
This chapter aims to demonstrate the practicality and effectiveness of the designed hardware. To ensure the design is effective, the performance of the design is evaluated by inspecting the latency of the filter, resource utilisation, timing and power consumption. The design is also tested with a small sample of real life packets of different properties to ensure the packet filter can correctly block unwanted packets. The performance of the design is then compared to preexisting solutions through latency, power and thermal tests.
