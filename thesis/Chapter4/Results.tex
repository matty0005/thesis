...
A series of tests were then done and the currents were measured. By pinging the device every 50ms, the average current consumption was 300.72mA. Interestingly, the current consumption was cyclic similar to what is shown in figure \ref{fig:ppk_udp_ping}. A UDP ping test was conducted (shown in figure \ref{fig:ppk_udp_ping}) and had an average current draw of 301.13mA. In both the ICMP and UDP pings, the current consumption was of similar style where the varience of the current was about 10mA. 



\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/PPK_udp.png}
    \caption[Current consumption of FPGA board with UDP pings]{Current consumption of FPGA board with UDP pings.}
    \label{fig:ppk_udp_ping}
\end{figure}
