<template>
  <div class="">
    <div class="flex flex-col">
      ...
      <div class="mx-4 my-2 rounded-xl px-2  text-gray-600 break-normal w-[68rem]">This website is hosted on a NeoRV32 RISC-V processor on a FPGA, namely the Xilinx Artix 7 100T FPGA - part number XC7A100T-1CSG324. This device features fully customised Ethernet hardware for both the MAC and filtering aspects. The website is written in Vue.js and is been hosted on a basic HTTP server running over the top of the FreeRTOS Plus TCP networking stack.</div>
   ...
   <div class="flex flex-row w-[68rem] my-4 mx-4 px-2">
      ...
      <div class="mx-4 rounded-xl px-2 text-gray-600">More information on this project can be found in the project repository, <a class="text-riscv-blue-l" target="_blank" href="https://github.com/matty0005/thesis">github.com/matty0005/thesis</a></div>
